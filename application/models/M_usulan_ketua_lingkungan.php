...
class M_usulan_ketua_lingkungan extends CI_Model
{
  ...
  public function get_lingkungan($lingkungan){
    return $this->db->query("SELECT * FROM lingkungan WHERE kode_lingkungan = '$lingkungan' ")->row_array();
  }
}
