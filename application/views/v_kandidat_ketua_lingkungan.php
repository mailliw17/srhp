        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Kandidat - Ketua Lingkungan
                        <div class="page-title-subheading"><?= $ket3; ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <form method="post">
                <div class="input-group">
                    <input list="data_lingkungan" type="text" class="form-control" name="nama_lingkungan" id="nama_lingkungan" autocomplete="off" placeholder="Masukan Lingkungan.." style="margin-left: 16px;">
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><img src="
                                                        <?= base_url(); ?>foto/ketua_lingkungan/<?= $row['foto']; ?>" width="100" height="100"></td>
                                            <td style="text-align: center;">
                                                <a href="<?= base_url(); ?>C_KandidatKetuaLingkungan/edit/<?= $row['id']; ?>">
                                                    <button type="button" class="btn btn-warning btn-sm">Edit</button>
                                                </a>
                                                <a href="#" data-toggle="modal" data-target="#Modal_hapus2<?= $row['id']; ?>">
