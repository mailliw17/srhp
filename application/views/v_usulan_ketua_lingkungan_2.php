                ...
                <div class="row">
                    <div class="col-sm-12 col-xl-6">
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                <h5 class="card-title">Formulir Usulan Ketua Lingkungan</h5>
                                <form class="" enctype="multipart/form-data" method="post" action="<?= base_url() ?>/C_usulanKetuaLingkungan/form_isian2">
                                    ...
                                    <div class="position-relative form-group"><label for="exampleSelect" class="">Asal Wilayah</label>
