        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div><?php
                            if ($this->session->userdata('ket7')) {
                                echo 'Perolehan Suara ketua Lingkungan';
                            } else {
                                echo "Silahkan Pilih Lingkungan";
                            }
                            ?>
                        <div class="page-title-subheading">
                            ...
                            if ($this->session->userdata('ket7')) {
                                ...
                                echo "Lingkungan yang terpilih akan ditampilkan hasil
                ...
                <div class="page-title-actions">
                    <button type="button" class="btn-shadow mr-3 btn btn-warning" data-toggle="modal" data-target="#modalTampil2">
                        <i class="fas fa-eye"> Tampilkan Lingkungan</i>
                    </button>
                    <a href="<?= base_url(); ?>C_SuaraKetuaLingkungan/print/<?=$this->session->userdata('kode_lingkungan'); ?>">
                        <button type="button" class="btn-shadow mr-3 btn btn-success" <?php if ($status != 'selesai' || !($this->session->userdata('kode_lingkungan'))): ?>disabled <?php endif; ?>>
        ...
        <div class="row">
            <div class="col-xl-6 col-sm-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">Calon Ketua Lingkungan</h5>
