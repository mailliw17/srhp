        ...
        <div class="app-main__inner">
            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>Menampilkan Calon Ketua Wilayah <?= $nama_wilayah ?>
                            <div class="page-title-subheading">Hak Suara : <?= $hs_wilayah; ?>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php if($status_pemilihan_wilayah_1 == 'belum'): ?>
                <div class="alert alert-warning text-center" role="alert">
                    Pemilihan Ketua Wilayah Belum Dibuka ! 
                </div>
            <?php else: ?>
                <?php if ($status_pemilihan_wilayah_1 == 'selesai'): ?>
                    <div class="alert alert-info text-center" role="alert">
                        Pemilihan Ketua Wilayah Telah Selesai ! 
                    </div>
                <?php else: ?> <!-- berjalan -->
                <?php if ($hs_wilayah == 0) : ?>
                    <div class="alert alert-info text-center" role="alert">
                        Anda Telah Memilih Ketua wilayah 
                    </div>
                <?php endif; ?>
                ...
                <div class="tab-pane tabs-animation fade show active" id="tab-content-1" role="tabpanel">
                    <div class="row">
                        ...
                        ?>
                                <div class="alert alert-waning col-md-12 text-center" role="alert">
                                    Data calon ketua wilayah <strong>belum</strong> masuk!
                                </div>
                                <?php
                            else :
                                    ...
                                    <div class="col-md-4" style="width: 15rem;">
                                        <div class="main-card mb-3 card">
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <a href="#" data-toggle="modal" data-target="#pilihKetuaWilayah<?= $row['id'] ?>" class="btn btn-primary">Pilih</a>
                                            </div>
                                        </div>
                                    </div>
                                <?php
                    ...
                    <div class="row">
                        <?php if($status_pemilihan_wilayah_1 == 'selesai'): ?>
                            ...
                            <?php else : ?>
                                <?php foreach ($ketua_wilayah as $row) :
                                    ?>
                                    <div class="card-body">
                                        <h5 class="card-title">kandidat yang anda pilih :</h5>
                                        <div class="col-md-6" style="width: 25rem;">
