    <div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>Menampilkan Calon Bendahara 2 DPH
            ...
            <?php else: ?>
                ...
                <?php if ($hs_dph == 0) : ?>
                    <div class="alert alert-info text-center" role="alert">
                        Anda Telah Memilih Bendahara 2 DPH 
                    </div>
                <?php endif; ?>
                    ...
                    <div class="row">
                        ...
                        ?>
                                <div class="alert alert-warning col-md-12 text-center" role="alert">
                                    Data calon Bendahara 2 DPH <strong>belum</strong> masuk!
                                </div>
                                <?php
                            else :
                                    ...
                                    <div class="col-md-4" style="width: 15rem;">
                                        <div class="main-card mb-3 card">
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <a href="#" data-toggle="modal" data-target="#pilihC83<?= $row['id'] ?>" class="btn btn-primary">Pilih</a>
                                            </div>
                                        </div>
                                    </div>
                                <?php
