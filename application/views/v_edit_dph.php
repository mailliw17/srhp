                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xl-6">
                                    <div class="main-card mb-3 card">
                                        <div class="card-body">
                                            <h5 class="card-title">Formulir edit usulan DPH</h5>
                                            <form class="" enctype="multipart/form-data" method="post">
                                                ...
                                                <div class="position-relative form-group"><label for="exampleSelect"
                                                        class="">Jabatan</label>
                                                    <input name="jabatan_lama" id="jabatan_lama" type="hidden" class="form-control-file" value="<?= $row['kandidat'];?>">
                                                    <input name="nama_lama" id="nama_lama" type="hidden" class="form-control-file" value="<?= $row['nama'];?>">

                                                    <select name="jabatan" id="jabatan" class="form-control" onchange="get_tombol()">
                                                        <option value="" selected disabled><?= $row['kandidat_dph']; ?></option>
                                                <?php
                                                    endforeach;
                                                ?>
                                                        <?php 
