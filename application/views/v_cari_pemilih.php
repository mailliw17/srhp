<div class="app-main__outer">
    <div class="app-main__inner">
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Cari data Pemilih
                        <div class="page-title-subheading"><?= $ket1; ?>
                        </div>
                    </div>
                </div>
                <div class="page-title-actions">
                    <a href="<?= base_url(); ?>C_PengaturanPemilih/tambah">
                        <button type="button" class="btn-shadow mr-3 btn btn-info">
                            <i class="fas fa-user-plus"> Tambah Pemilih</i>
                        </button>
                    </a>
                </div>
            </div>
        ...
        <?php if ($this->session->flashdata('tambah')) : ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                Tambah Pemilih <strong><?= $this->session->flashdata('tambah'); ?> !</strong>
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                                            ...
                                            ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align: center;">
                                                                <a href="<?= base_url(); ?>C_PengaturanPemilih/edit/<?= $row['no']; ?>">
                                                                    <button type="button" class="btn btn-success btn-sm">Edit</button>
                                                                </a>
                                                                <?php if($row['tipe'] == 2) : ?>
                                                                    <a href="<?= base_url(); ?>C_PengaturanPemilih/ubahHakPilih/<?= $row['no']; ?>">
                                                                        <button type="button" class="btn btn-info btn-sm"><i class="fas fa-plus"></i>&nbsp;Hak Pilih DPH</button>
                                                                    </a>
                                                                <?php endif; ?>
                                                                <a href="#" data-toggle="modal" data-target="#Modal_hapusPemilih<?= $row['no']; ?>">
